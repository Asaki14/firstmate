...
# the grok, rovo, and agy arms. Recurring supervision callers pass their
# passive monitor capture here; the absent-tail fallback uses historical
# fm_backend_capture only for one-shot callers such as explicit control
# diagnostics, else reports unknown capture-failed.
